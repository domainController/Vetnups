...
- `index.html` — the whole page (HTML/CSS/JS inline, no build step, no dependencies).
- Fonts load from Google Fonts (IBM Plex Sans, IBM Plex Mono) over a CDN link; everything
